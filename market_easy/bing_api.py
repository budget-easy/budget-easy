from market_easy.auth_helper import *
from market_easy.output_helper import *
from market_easy.adinsight_example_helper import *
import pandas as pd
...
def main(authorization_data, keyword_texts, adinsight_service):
    ...
    try:
        ...
        bing_df = bing_df[['Keyword', 'MonthlySearchCounts','Competition', 'platform','SuggestedBid']]
        bing_df.columns = ['keyword', 'avg_monthly_searches', 'competition', 'platform', 'suggested_bid']
        bing_df['avg_monthly_searches'] = bing_df['avg_monthly_searches'].apply(lambda x: list(x)[0][1][0])
        return bing_df
