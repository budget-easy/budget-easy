    ...
    for idea in keyword_ideas:
        ...
        keywords_df.append(
            {       'keyword': idea.text,
                    ...
                    'platform':'google',
                    'suggested_bid': ((idea.keyword_idea_metrics.low_top_of_page_bid_micros + idea.keyword_idea_metrics.high_top_of_page_bid_micros) / 2)/10000
            }
        )
...
def get_data(keyword_texts):
    ...
    googleads_client = GoogleAdsClient.load_from_storage("/Users/damjan/neuefische/capstone-project-tem-2/google_api/my_api/googleads.yaml")
