...
language_id = "1000"
keyword_texts = ["flat", "house", "inventory"]
page_url = ""
...
def main(
    ...
    for idea in keyword_ideas:
        ...
        print(
            ...
            f'average monthly searches, "{competition_value}" competition'
            f' with a low price of "{idea.keyword_idea_metrics.low_top_of_page_bid_micros}" '
            f' and a high price of "{idea.keyword_idea_metrics.high_top_of_page_bid_micros}" \n'
        )
